...
public class DukasBuilder {

	static DukasClientHost newClient(final DukasUserConfBuilder confBuilder)
			throws Exception {
		...
		final Application application = new DukasClientApp(settings);

		final DukasClientHost client = new DukasClientHost(settings, application);
